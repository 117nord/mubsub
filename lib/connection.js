 ...
 * @api public
 */
Object.defineProperty(Connection.prototype, 'state', {enumerable: true
  , get: function () {
        var state;
 ...
 * @api public
 */
Connection.prototype.channel = function(name, options, backlogCount) {
    ...
    if (!this.channels[name] || this.channels[name].closed) {
        this.channels[name] = new Channel(this, name, options, backlogCount);
    }
